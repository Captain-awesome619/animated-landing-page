    ...
    () => {
      ...
      const heroTl = gsap.timeline({
        ...
        scrollTrigger: {
          ...
          start: 'top top',
          end: `bottom+=${10 * window.innerHeight}`,
          scrub: 1,
          pin: true,
          anticipatePin: 1,
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-[10%] justify-between h-screen">
            ...
            >
              <div className="flex right-[-5%]">
                ...
                />
                <div
                  className="flex items-center justify-center w-[250px] md:w-[350px] h-[60%] absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-[40%] md:translate-y-[50%] lg:translate-x-[70%] lg:translate-y-[40%] origin-center"
                  ref={smallImgRef}
                >
