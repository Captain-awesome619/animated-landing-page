...
const FaqSection = () => {
  ...
  useGSAP(
    () => {
      ...
      faqTl
        .to(topfaqref.current, { y: 0, duration: 0.25, ease: 'power2.inOut' })
        .to(catref.current, { x: 0, ease: 'power2.inOut' }, 0)
        .to(queref.current, { x: 0, ease: 'power2.inOut' }, 0)
    },
    { scope: faqpref }
  )

  return (
    <div ref={faqpref} className="bg-[#F5F5F5]">
      <div id="faq" className="py-10 container hero ">
        <section className="overflow-hidden">
          <div
            ref={topfaqref}
            className="flex flex-col md:flex-row justify-between items-start translate-y-[150%] pt-10 md:pt-16 md:items-center mb-12 gap-4 md:gap-8"
          >
            {/* Left - Heading */}
            ...
            <div className="md:w-1/1.2 text-lg sm:text-[.875rem] text-gray-600">
              <p>
                ...
                you're looking for? Please chat with{' '}
                <a
                  href="#"
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div
            ref={catref}
            className="-translate-x-[150%] md:w-1/3 categories-card"
          >
          ...
          <div
            ref={queref}
            className="translate-x-[150%]  md:w-2/3 md:px-8 faqs-section"
          >
            <div className="bg-white rounded-xl p-6 shadow">
              ...
              {faqData[selectedCategory].map((faq, index: number) => (
                <div
                  ...
                  className="border-b py-3 border-[#0000001A]"
                >
                  <button
