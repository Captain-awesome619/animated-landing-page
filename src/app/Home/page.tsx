...
const HomePage = () => {
  return (
    <>
      ...
      <Hero title="Save Smart. Pay Fast. Earn Big." description="Whether you're saving for your future, making quick payments, or running a business. Xtrempay makes it fast, fun, and financially rewarding." ctaLink="/" ctaText="Download" videoText="Watch our video" imageAlt="Xreampay App" imageSrc="/images/Xtrempay-min.png" imageClassName="hero__img1" imgHeight={500} imgWidth={1100} bgColor="transparent" layoutVariant="split" colSet="1/3"/>
